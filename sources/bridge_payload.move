module aoxc::bridge_payload {
    ...
    public fun new_bridge_payload(
        ...
        BridgePayload { schema_version, kind, target_module, ref_id, note, proof_root }
    }
    ...
    public fun encode_pause_payload(
        ...
        let payload = PausePayload { schema_version, target_module, ref_id, reason, proof_root };
    ...
    public fun encode_resume_payload(
        ...
        let payload = ResumePayload { schema_version, target_module, ref_id, reason, proof_root };
        bcs::to_bytes(&payload)
    }
    ...
    public fun encode_fund_update_payload(
        ...
        let payload = FundUpdatePayload { schema_version, target_module, ref_id, policy_name, proof_root };
        bcs::to_bytes(&payload)
    }
